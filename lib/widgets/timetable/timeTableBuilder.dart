...
class TimeTableSlider extends StatefulWidget {
  ...
  String sel;
  TimeTableSlider({Key? key,required this.data, required this.sel}) : super(key: key);
...
class _TimeTableSliderState extends State<TimeTableSlider> {
  ...
  Widget build(BuildContext context) {
    int select= context.read<TimetableStore>().selectedDate;
    ...
    return Observer(
      builder: (context) {
        ...
        return ListView.builder(
            ...
            itemCount: widget.data[dates[select - 1].weekday]!.length,
              ...
              return Padding(
                ...
                child: Container(
                  decoration: BoxDecoration(
                    ...
                    color:
                    (widget.sel == widget.data[dates[select - 1].weekday]![index][0])
                      ...
                      children: [
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              Text(
                                widget.data[dates[select -1].weekday]![index][0],
                                style: MyFonts.w300
                                    .size(12)
                                    .setColor(kWhite),
                              ),
                              ...
                              Row(
                                children: [
                                  Expanded(
                                    child: Text(
                                      widget.data[dates[select -1].weekday]![
                                      index][1],
                                      style: MyFonts.w500
                                          .size(15)
                                          .setColor(kWhite),
                              ...
                              Row(
                                children: [
                                  ...
                                  // ),
                                  Text(
                                    widget.data[dates[select-1].weekday]![index]
                                    [2],
                                    style: MyFonts.w300
                                        .size(13)
