      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              CircleAvatar(
                ...
                child: Icon(FluentIcons.book_open_16_filled, color: OColor.green600, size: 24),
              ),
              const SizedBox(width: 12),
              Expanded(
                child: OText(
                  text: "About Travel Guide",
                  style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: OColor.black),
          ...
          OText(
            ...
            style: TextStyle(fontSize: 14, color: OColor.black, height: 1.4),
            maxLines: 6,
