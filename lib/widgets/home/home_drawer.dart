          ...
          title: RichText(
            text: TextSpan(
              children: [
                ...
                TextSpan(text: ".", style: OnestopFonts.w500.size(23).setColor(kYellow)),
              ],
            ),
          ),
        ),
            ...
            children: [
              ...
              GestureDetector(
                onTap: () {
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder:
                          (buildContext) =>
                              ProfilePage(profileModel: OneStopUser.fromJson(LoginStore.userData)),
                    ),
                  );
                ...
                child: Padding(
                  ...
                  child: Text("View Profile", style: OnestopFonts.w400.size(14).setColor(kWhite)),
                ),
              ),
              ...
              TextButton(
                child: Text("Logout", style: OnestopFonts.w400.size(18).setColor(kRed)),
                onPressed: () {
                  {
                    LoginStore().logOut(
                      () => Navigator.of(
