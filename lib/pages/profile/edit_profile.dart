    ...
    Future<void> onFormSubmit() async {
      if (!isLoading) {
        ...
        if (!_formKey.currentState!.validate()) {
          ...
          DateTime date = DateTime(selectedDob!.year, selectedDob!.month, selectedDob!.day);
          var data = {
          ...
          await LoginStore().saveToUserInfo(prefs); // automatically updates token & other user info
      ...
      child: Scaffold(
        ...
        body: SafeArea(
          child: Column(
            children: [
              if (isLoading)
                LinearProgressIndicator(color: OColor.green600, backgroundColor: OColor.green100),
                        ...
                        child: Column(
                          children: [
                            ...
                            CustomDropDown(
                              ...
                              label: 'Hostel',
                              onChanged: (String h) => hostel = h.getHostelFromDisplayString()!,
                              validator: (String? value) {
                                if (value == null) {
                                  return 'Field cannot be empty';
                                }
                                final selectedHostel = value.getHostelFromDisplayString();
                                if (selectedHostel == null || selectedHostel == Hostel.none) {
                                  return 'Field cannot be empty';
                                }
                                return null;
                              },
                            ...
                            CustomDropDown(
                              ...
                              onChanged: (String m) => mess = m.getMessFromDisplayString()!,
                              validator: (String? value) {
                                {
                                  return null;
                                }
