        ...
        //     child:
            ...
            //   children: [
                FutureBuilder<SharedPreferences>(future: SharedPreferences.getInstance(), builder: (context,snapshot) {
                  if(snapshot.hasData){
                    return ListView.builder(itemCount: snapshot.data!.getStringList('notifications')!.length, itemBuilder: (context, index){
                      return Text(snapshot.data!.getStringList('notifications')![index],style: TextStyle(color: Colors.white),);
                    });
                  }
