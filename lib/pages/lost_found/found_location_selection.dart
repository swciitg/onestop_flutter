...
class LostFoundLocationForm extends StatefulWidget {
  ...
  LostFoundLocationForm({Key? key, required this.imageString})
      : super(key: key);
        ...
        ConstrainedBox(
          ...
          child: Container(
              ...
              decoration: BoxDecoration(
                  color: kBlueGrey, borderRadius: BorderRadius.circular(25)),
              child: Padding(
                padding:
            ...
            Theme(
              ...
              child: Container(
                ...
                child: DropdownButtonFormField<String>(
                  value: selectedDropdown == "Library"
                      ? selectedLocation
                      : "Library",
                  icon: Icon(
        ...
        onTap: () {
          if (checkBox == false) {
            ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                content:
                    Text("Mark the checkbox if you have submitted the item")));
            return;
          }
          if (selectedLocation == null ||
              ["Library", "Hostel", "Core", "SAC"].contains(selectedLocation)) {
            ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                content: Text("Please select location of item submission")));
            return;
          }
